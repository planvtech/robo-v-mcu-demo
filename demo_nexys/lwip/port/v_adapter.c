...
#include "port/lowlevel_skeleton.h"
...
//  LWIP_ASSERT("state != NULL", (netif->state != NULL));
  ...
  ethernetif->low_level_endinput = low_level_endinput;
  ethernetif->low_level_endoutput = low_level_endoutput;
  ethernetif->low_level_input = low_level_input;
  ethernetif->low_level_input_nomem = low_level_inputnomem;
  ethernetif->low_level_output = low_level_output;
  ethernetif->low_level_startinput = low_level_startinput;
  ethernetif->low_level_startoutput = low_level_startoutput;
